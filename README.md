...
describe() is optional and makes the test more organized
it() runs the actual unit test

1. What is the point of `Test Driven Development`? What do you think about this approach?

You write a test that specifies and checks what the code will do. The test fails if ther is no code. Then you write the code and refactor the code.

1. Mention three types of automated tests.

Regression test, unit test, and intergration test.
